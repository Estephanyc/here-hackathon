/*
	Rollup.js v0.60.4
	Wed, 13 Jun 2018 06:55:49 GMT - commit e6b4cf9b89f8105ba294270c5fb65c8397e2d317
...
var Scope = /** @class */ (function () {
    ...
    Scope.prototype.addDeclaration = function (identifier, options) {
        ...
        if (this.variables[name]) {
            ...
            this.variables[name] = new LocalVariable(identifier.name, identifier, options.init || UNDEFINED_EXPRESSION);
        }
...
var ModuleScope = /** @class */ (function (_super) {
    ...
    function ModuleScope(parent, context) {
        ...
        _this.variables.this = new LocalVariable('this', null, UNDEFINED_EXPRESSION);
        return _this;
    }
